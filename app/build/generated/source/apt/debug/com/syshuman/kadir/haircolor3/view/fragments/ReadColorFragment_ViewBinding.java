...
public class ReadColorFragment_ViewBinding implements Unbinder {
  private ReadColorFragment target;

  @UiThread
  public ReadColorFragment_ViewBinding(ReadColorFragment target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    ReadColorFragment target = this.target;
